    ...
    const features = [
        {
            ...
            title: "GPT4 powered chatbots",
            desc: "Collect your customer needs, provide them with automated custom insights, and much more."
        },
        {
            icon:
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            title: "Powerful and flexible integrations",
            desc: "Our API's or custom environment deployment allows you to keep control of your stack while maximizing time to market"
        },
        {
            icon:
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            ...
            title: "Powerfull Analytics to All! From your customers to your portfolio managers",
            desc: "Understand any event like you never did before."
        },
    ]
            ...
            <div className="custom-screen text-gray-300 justify-between gap-24 lg:flex">
                <div className="max-w-xl">
                    <h2 className="text-white text-3xl font-semibold sm:text-4xl">
                        We fine-tune Large Language Models (LLMs) to your organisation
                    </h2>
                    <p className="mt-3">
                        Customers look for modern ways to engage with their finances, let us help you modernise your technology to fit the needs of diverse generations of investors.
                    </p>
                </div>
