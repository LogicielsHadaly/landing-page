...
const DecisionMaking = () => {
  ...
  return (
    <SectionWrapper id="main" className=" overflow-hidden  bg-indigo-50 bg-opacity-50 mx-auto ">
      ...
      <div className="flex flex-col md:flex-row md:items-center max-w-screen-4xl mx-auto px-4 md:px-8">
