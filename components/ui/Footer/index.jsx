            ...
            <div className="flex flex-wrap gap-y-10 items-center justify-between">
                <div className="space-y-4">
                    ...
                    <div className="pt-2 flex items-center gap-x-6 text-gray-400">
                        <a href="https://twitter.com/hadaly_finance" target="_blank" aria-label="Social media">
                        ...
                        <a href="https://www.linkedin.com/company/hadaly/" target="_blank" aria-label="Social media">
