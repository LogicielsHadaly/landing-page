...
//             Hadaly enable your team to classify, cleanse and transform different types of data using our API. Whether PDF documents, voice recordings, video files, Excel spreadsheets or any other format.
//             </p>
//           </div>
//         </SlideIn>
//         <SlideIn>
      ...
      <div className="custom-screen flex flex-col-reverse gap-x-12 justify-between md:flex-row md:items-center mt-24 mb-24">
        ...
        <SlideIn>
          <div className="flex-none max-w-xl mt-12 space-y-3 md:mt-0 bg-gray-400 bg-opacity-30 p-4 rounded-xl shadow-lg">
            ...
            Hadaly helps you understand your data room faster by letting you chat with  <strong>any document</strong> and get answers to your questions within seconds.
