    ...
    >
      <div className="space-y-12  py-48 max-w-4xl mx-auto text-center h-screen">
        ...
        <div className="flex items-center justify-center gap-x-3 font-medium text-sm">
          <NavLink
            href="#contact"
            className="flex items-center rounded-lg gap-x-2 text-2xl text-white bg-slate-950 hover:bg-slate-800 active:bg-[#10B981] "
            scroll={false}
          >
            Get in touch
            <svg
...
//               <div style={{ display: 'inline-block', width: '100%' }}>
//               Data Room Copilot for <TextAnimation />
//               </div>
//               {/* <div>Portfolio Process</div> */}
//             </h1>
